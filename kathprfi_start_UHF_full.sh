...
"--volume=\"/data/nadeem/DS:/home/nadeem/DS:rw\" "\
"--volume=\"/data/nadeem/DS/KATHPRFI_UHF/RDB_FILES:/home/nadeem/DS/KATHPRFI_UHF/RDB_FILES:rw\" "\
"--volume=\"/data/nadeem/DS/KATHPRFI_UHF/FLAG_FILES:/home/nadeem/DS/KATHPRFI_UHF/FLAG_FILES:rw\" "\
"--volume=\"/data/nadeem/DS/KATHPRFI_UHF/OUT_ZARR:/home/nadeem/DS/KATHPRFI_UHF/OUT_ZARR:rw\" "\
"--volume=\"/data/nadeem/DS/KATHPRFI_UHF/GOOD_FILES:/home/nadeem/DS/KATHPRFI_UHF/GOOD_FILES:rw\" "\
"--volume=\"/data/nadeem/DS/KATHPRFI_UHF/BAD_FILES:/home/nadeem/DS/KATHPRFI_UHF/BAD_FILES:rw\" "\
"--volume=\"/tmp:${HOME}:rw\" "\
"-e HOME=\"${HOME}\" "\
"--user=`id -ur` "\
"--net=host "\
...
alias kathUhfFull="docker run ${DOCKER_OPTS} --name $DOCKER_NAME $DOCKER_NAME python3 $HOME/DS/Isaac/kathprfi/kathprfiUHF.py --vis /home/nadeem/DS/KATHPRFI_UHF/RDB_FILES --flags /home/nadeem/DS/KATHPRFI_UHF/FLAG_FILES --zarr /home/nadeem/DS/KATHPRFI_UHF/ZARR_FILES/UHF_20200304_20201104.orig.csv.zarr --good /home/nadeem/DS/KATHPRFI_UHF/GOOD_FILES/gd_files.npy --bad /home/nadeem/DS/KATHPRFI_UHF/BAD_FILES/bd_files.npy -n 1 --tokenPresent UHF_20200304_20201104.orig.csv_4fulltest "
