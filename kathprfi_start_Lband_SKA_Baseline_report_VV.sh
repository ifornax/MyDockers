...
CFGFILE="$HOME/KATHPRFI/RDB_FILES/kathprfi_config_file_template_Lband_SKA_Baseline_report_VV.txt"
# These are for output

OUTZARR="$HOME/KATHPRFI/OUT_ZARR/lband_${BAND}_.zarr"
GOODFILES="$HOME/KATHPRFI/GOOD_FILES/good_files_lband_${BAND}_Visitor.npy"
BADFILES="$HOME/KATHPRFI/BAD_FILES/bad_files_lband_${BAND}_Visitor.npy"
