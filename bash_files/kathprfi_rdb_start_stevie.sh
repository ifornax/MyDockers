...
#alias kathprfiolddocker="docker run ${DOCKER_OPTS} --name $DOCKER_NAME $DOCKER_NAME python2 --version"

#alias kathprfiolddocker="docker run ${DOCKER_OPTS} --name $DOCKER_NAME $DOCKER_NAME python2 $HOME/GitHub/Old_code/KATHPRFI_offline.py --vis /home/nadeem/KATHPRFI/RDB_FILES --flags /home/nadeem/KATHPRFI/FLAG_FILES --zarr /home/nadeem/KATHPRFI/ZARR_FILES --good /home/nadeem/KATHPRFI/GOOD_FILES/gd_files.npy --bad /home/nadeem/KATHPRFI/BAD_FILES/bd_files.npy -n 1"

echo "This will Running Nadeem version of code"
alias kathprfiolddocker="docker run ${DOCKER_OPTS} --name $DOCKER_NAME $DOCKER_NAME python2 $HOME/GitHub/Old_code/kathprfiNO.py --vis /home/nadeem/KATHPRFI/RDB_FILES --flags /home/nadeem/KATHPRFI/FLAG_FILES/ --zarr /home/nadeem/KATHPRFI/ZARR_FILES/ --good /home/nadeem/KATHPRFI/GOOD_FILES/gd_files.npy --bad /home/nadeem/KATHPRFI/BAD_FILES/bd_files.npy -n 1"
