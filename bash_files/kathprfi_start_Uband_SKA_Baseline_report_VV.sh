...
CFGFILE="$HOME/KATHPRFI/RDB_FILES/kathprfi_config_file_template_Uband_SKA_Baseline_reportVV.txt"
...
alias kathprfiLbandvv="docker run ${DOCKER_OPTS} --name $DOCKER_NAME $DOCKER_NAME python3 $SCRIPT -c $CFGFILE -z $OUTZARR -b $BADFILES -g $GOODFILES"
